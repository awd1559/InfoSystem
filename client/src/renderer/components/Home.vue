...
<script>
  import StudyTabPage from './study/StudyTabPage'
  import NoteTabPage from './note/NoteTabPage'
  import CodingTabPage from './coding/CodingTabPage'
  import CompanyTabPage from './company/CompanyTabPage'
